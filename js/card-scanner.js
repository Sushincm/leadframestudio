// Optimized Card Scanner Animation
// Performance-focused implementation with theme integration
...
class CardStreamController {
  ...
  calculateDimensions() {
    ...
    const cardGap = window.innerWidth <= 768 ? 40 : 60;
  ...
  createCardWrapper(index) {
    ...
    cardImage.alt = "Website Preview";
    cardImage.loading = "lazy"; // Performance optimization

    cardImage.onerror = () => {
      const canvas = document.createElement("canvas");
      canvas.width = window.innerWidth <= 768 ? 300 : 400;
      canvas.height = window.innerWidth <= 768 ? 188 : 250;
    ...
    const cardWidth = window.innerWidth <= 768 ? 300 : 400;
    const cardHeight = window.innerWidth <= 768 ? 188 : 250;
...
// Optimized Particle System with Three.js
class ParticleSystem {
  constructor() {
    ...
    this.renderer = null;
    this.particles = null;
    this.particleCount = window.innerWidth <= 768 ? 200 : 400; // Reduce for mobile
  ...
  createParticles() {
    ...
    const hue = 270; // Purple/violet to match theme
...
// Optimized Scanner Particle System
class ParticleScanner {
  constructor() {
    ...
    this.particles = [];
    this.count = 0;
    this.maxParticles = window.innerWidth <= 768 ? 400 : 800; // Reduce for mobile
    this.intensity = 0.8;
    ...
    this.scanTargetParticles = window.innerWidth <= 768 ? 1200 : 2500;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (document.getElementById("card-scanner")) {
